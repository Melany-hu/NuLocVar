  ...
  <section id="main" class="d-flex justify-cntent-center align-items-center">
    <div class="container" id="download">
      ...
      <div class="card">
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                ...
                <select class="form-control" name="dataset" id="dataset">
                  <option value="iNuLoC">iNuLoC</option>
                </select>
              </div>
              <div class="col-md-8">
        ...
        <div class="card-footer">iNuLoC is ONLY freely available for academic research. For commercial usage, please <a href="about.php" class='text-danger font-weight-bold'>contact us</a>.</div>
      </div>
